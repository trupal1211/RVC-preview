...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <Navbar />
      <main className="relative z-10 pt-20 md:pt-32 pb-12 md:pb-16">
        <div className="container max-w-4xl md:max-w-6xl px-4 md:px-6">
          <Link to="/" className="mb-4 md:mb-6 flex items-center w-max text-primary font-medium hover:underline transition-all">
          ...
          >
            ...
            <div className="space-y-4 relative">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div>
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold gradient-text">Privacy Notice</h1>
                </div>
              </div>
            </div>

            {/* Content Sections */}
            <div className="prose prose-invert max-w-none space-y-6 md:space-y-8 text-base text-left md:text-justify overflow-hidden break-words">
              ...
              <section className="space-y-4">
                ...
                <ul className="list-decimal list-inside space-y-2 text-gray-500 ml-2">
                ...
                <ul className="list-decimal list-inside space-y-3 text-gray-500 ml-2">
                  <li>
              ...
              <section className="space-y-4">
                ...
                <div className="glass-strong rounded-xl p-4 pl-0 ">
                  ...
                  <p className="text-gray-500">2040 Martin Ave</p>
                  <p className="text-gray-500">Santa Clara, CA 95050</p>
