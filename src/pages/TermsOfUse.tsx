      ...
      <main className="relative z-10 pt-20 md:pt-32 pb-12 md:pb-16">
        <div className="container max-w-4xl md:max-w-6xl px-4 md:px-6">
          ...
          >
            ...
            {/* Content Sections */}
            <div className="prose prose-invert max-w-none space-y-6 md:space-y-8 text-left md:text-justify overflow-hidden break-words">
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-500 leading-relaxed mb-3 text-sm md:text-base">You agree that you will not:</p>
